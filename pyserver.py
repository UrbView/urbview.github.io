...
def index():
    return """{
            response: [
                {confidence: 98.32, keywords: ['good','yes','green'], label: true},
                {confidence: 12.34, keywords: ['bad','no','red'], label: false},
                {confidence: 78.32, keywords: ['good','yes','green'], label: true}
            ],
            aggregation: {confidence: 62.32, keywords: ['good','yes','green'], label: true},
